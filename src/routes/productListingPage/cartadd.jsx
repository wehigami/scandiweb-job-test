...
import { setCart, setCartIncrement } from "../../redux/cartSlice";
...
class CartAdd extends React.Component {
  ...
  render() {
    let cartClick = () => {
      ...
      if (
        this.props.cart[this.props.cart.findIndex((item) => item.id === fullId)]
      ) {
    ...
    return (
      <div>
        ...
        >
          <img src={Cart} alt="cart" className={style.img} height="24px" />
        </div>
      </div>
    );
  }
